 ...
 * @author ADMIN
 */
public class RoleController extends BaseRequiredAuthenController {
    ...
    protected void processGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Group> groups = decenDB.getGroups();
        request.setAttribute("groups", groups);
        request.getRequestDispatcher("/view/admin/RoleManager.jsp").forward(request, response);
    }
