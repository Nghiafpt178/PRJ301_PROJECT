<%-- 
    Document   : Infor
    Created on : Oct 29, 2021, 10:38:54 AM
    Author     : ADMIN
--%>
...
<html>
    ...
    <body>
       ...
       <hr>
       <div class="container bootstrap snippet" style="margin-bottom: 80px;" >
            <div class="row">
                ...
                <div class="col-sm-9">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="home">
                            ...
                            <form class="form" action="infor" id="registrationForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <input type="text" class="form-control" name="passcurrent" id="phone" placeholder="Password current" >
                                    </div>
                                </div>
